...
**Design goal: minimize complexity — no modification to the original passive sampler.**
...
::: {.notes}
1.5 min. Walk the chain verbally: level rises → valve closes → reed switch → cold boot → LoRaWAN/TTN → Python gateway → email. Emphasize retrofit: plug + flexible cable, mount/dismount by hand in the field.
:::
