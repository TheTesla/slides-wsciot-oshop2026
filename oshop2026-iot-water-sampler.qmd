...
author: "Stefan Helmert, Fouad Bahrpeyma, Till Haas, Dirk Reichelt · Thomas Grischek, Friedemann Sell"
date: "23.09.2026"
format:
  revealjs:
    theme: [default]
...
<div class="title-slide">
  ...
  <div class="ts-photo">
    <img src="photos/WSCcomplete.jpg" alt="Water sampler" />
  </div>
  <div class="ts-text">
    <h1>IoT Monitoring Solution for Event-Based Water Sample Collection — Lessons Learnt</h1>
  </div>
  <div class="ts-meta">
    <div class="meta-title">IoT monitoring solution for event based water sample collection</div>
    <div class="meta-name">Stefan Helmert, Fouad Bahrpeyma, Till Haas, Prof. Dirk Reichelt, Prof. Thomas Grischek, Friedemann Sell</div>
    <div class="meta-faculty">Smart Production Systems / Water Management, HTW Dresden</div>
...
::: columns
::: {.column width="55%"}
- Floods & heavy rain mobilize pollutants: heavy metals, pesticides, microplastics, pathogens
...
## The problem with passive samplers
...
## Our solution: retrofit notifier
...
<img src="logos/logo-vwstiftung-dark.svg" alt="VolkswagenStiftung" style="height: 24px;" />
...
(function() {
  function addFooter() {
    ...
    slides.forEach(function(slide, index) {
      ...
      footer.innerHTML =
        '<img class="footer-logo" src="logos/HTWD_logo_RGB_horizontal_color.svg" alt="HTWD" />' +
        '<span class="footer-date">23.09.2026</span>' +
        '<span class="footer-title">IoT Water Sampler – Lessons Learnt / Smart Production Systems / Helmert et al.</span>' +
        '<span class="footer-slide">' + index + '</span>';
