...
format:
  revealjs:
    ...
    css: [htwd-theme.css]
    include-after-body: presenter.html
...
<div class="title-slide">
  ...
  <div class="ts-meta">
    ...
    <div style="display:flex; align-items:center; gap:14px; margin-top:10px;">
      <img src="data:image/png;base64," alt="QR code: slides online" style="height:90px; width:90px;" />
      <span style="font-size:0.75em; color:#555;">Slides online:<br><strong>thetesla.github.io/slides-wsciot-oshop2026</strong></span>
    </div>
  </div>
</div>
```
...
- 1 min — Why event-based sampling (WFD, passive sampler)
- 4 min — What we built: retrofit LoRaWAN notifier
- 7 min — 4 lessons: coverage · cold boot · errors & unknowns · real-world problems
- 1.5 min — 3 recommendations for OSH
- 10 min — Discussion with you

::: {.notes}
Total ~14.5 min. Keep motivation short, spend most time on lessons 1–4. End with explicit invitation for Q&A.
:::
...
<img src="photos/pn_head_old.png" alt="Old passive sampler head (PN)" style="height: 300px; width: auto; display: block; margin: 1.5em 0 0 0;" />
:::
::: {.column width="42%"}
...
(function() {
  function addFooter() {
    ...
    slides.forEach(function(slide, index) {
      ...
      footer.innerHTML =
        '<img class="footer-logo" src="data:image/svg+xml;base64," alt="HTWD" />' +
