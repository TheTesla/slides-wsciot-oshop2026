...
::: {style="font-size: 0.8em; color: grey; display: flex; align-items: center; justify-content: center; gap: 2em; margin-top: 2.5em; margin-bottom: 1.5em;"}
<img src="logos/logo-vwstiftung-dark.svg" alt="VolkswagenStiftung" style="height: 32px; margin-right: 1.5em;" />
