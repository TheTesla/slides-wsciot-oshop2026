---
title: "IoT Monitoring Solution for Event-Based Water Sample Collection"
subtitle: "Lessons Learnt"
author: "Stefan Helmert, Fouad Bahrpeyma, Till Haas, Dirk Reichelt (Smart Production Systems) — Thomas Grischek, Friedemann Sell (Water Management)<br>HTW Dresden – University of Applied Sciences"
institute: "oSHOP Conference 2026 · Halle (Saale) · 23–24 Sept 2026"
date: "2026-09-23"
format:
  revealjs:
    theme: [default]
    ...
    chalkboard: false
    preview-links: auto
    footer: "oSHOP 2026 · Helmert et al. · HTW Dresden · IoT Water Sampler – Lessons Learnt"
...
## Why event-based sampling? {.smaller}

::: columns
::: {.column width="55%"}
- Floods & heavy rain mobilize pollutants:
  heavy metals, pesticides, microplastics, pathogens
- Pollution peak is **short and unpredictable**
- EU Water Framework Directive: sample → lab **within 48 h**
...
Blue protective tube (fixed in river) + removable insert: IoT module → valve head → bottle.
:::
:::
:::

::: {.notes}
1 min. Key message: floods cause transient pollution, 48h holding time makes timing critical.
:::

---

## The problem with passive samplers {.smaller}

::: columns
::: {.column width="50%"}
**Passive sampler (existing, open design):**

- Installed at fixed inlet elevation
- Fills automatically when river stage exceeds threshold
- Valve with float + magnet closes when full

**But:**

- ❌ No notification → staff drive out to check
- ❌ Often find it **empty**
- ❌ Labour-intensive, easy to miss 48 h window
:::
::: {.column width="50%"}
...
::: {.notes}
1 min. Stress: sampler itself works well, the missing piece is information.
:::

---

## Our solution: retrofit notifier {.smaller}
...
## Design for years without power {.smaller}
...
## Open-source throughout {.smaller}
...
## Lesson 1: Coverage — not standby — kills the battery {.smaller}
...
::: {.notes}
2 min. This is the core surprise: 6 months testing showed connectivity, not standby, depletes battery. TTN console gives no downlink metadata — debugging is blind.
:::

---

## Lesson 2: Cold boot is a feature {.smaller}
...
## Lesson 3: Small parts, big delays {.smaller}

| Part | What happened | Fix |
|---|---|---|
| **SAMD21 POR** | Supercaps ramp < 1 V/ms → POR never fires → undefined boot, manual reset needed | Add MAX809 supervisor next rev (one-time at deploy, but must fix) |
| **MCP7940 crystal** | Common CC4V-T1A (2.1 fF) doesn't oscillate; needs high motional C + <70 kΩ ESR — **not in datasheet**, only in app note | CM7V-T1A from compatibility list |
...
![](photos/batteryspring.jpg){height="220px" fig-align="center"}
...
## Lesson 4: Mechanics & materials > electronics {.smaller}
...
## Conclusion: 3 recommendations {.smaller}
...
Funded by VolkswagenStiftung, grant 9C858. Full paper in oSHOP 2026 proceedings (Qucosa).
:::
...
## Backup: numbers at a glance {.smaller}
