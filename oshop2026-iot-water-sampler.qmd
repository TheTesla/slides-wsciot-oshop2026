...
- Field reality: **LoRaWAN retries dominate**
  - 20 mA for 20 s per retry cycle
...
::: {style="font-size: 0.7em; color: grey;"}
RSSI −118…−134 dBm: join at SF12, ADR pushes uplink to SF9 — never arrives.
:::
:::
:::

::: {.notes}
2 min. Core surprise: 6 months testing showed connectivity, not standby, depletes battery. 20 mA @ 20 s per retry cycle; hard retry limit + register device with SF12, not TTN "recommended" SF9. TTN console gives no downlink metadata — debugging is blind.
:::
